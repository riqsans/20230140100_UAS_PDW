...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-800">420</p>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-800">666</p>
        </div>
    </div>
</div>
...
<div class="bg-white p-6 rounded-lg shadow-md mt-8">
    ...
    <div class="space-y-4">
        <div class="flex items-center">
            ...
            <div>
                <p class="text-gray-800"><strong>Joko Kendil</strong> mengumpulkan laporan untuk <strong>Modul 2</strong></p>
                <p class="text-sm text-gray-500">50 menit lalu</p>
            </div>
        </div>
        <div class="flex items-center">
            <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center mr-4">
            ...
            <div>
                <p class="text-gray-800"><strong>Davina Karamoy</strong> mengumpulkan laporan untuk <strong>Modul 1</strong></p>
                <p class="text-sm text-gray-500">15 menit lalu</p>
            </div>
        </div>
    </div>
</div>
